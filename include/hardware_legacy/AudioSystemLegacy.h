...
public:
    ...
    enum stream_type {
        ...
        DTMF             = 8,
        TTS              = 9,
        FM               = 10, // This should be kept because static arrays are used with this const
        NUM_STREAM_TYPES
    };
    ...
    enum audio_devices {
        ...
        DEVICE_OUT_ANLG_DOCK_HEADSET = 0x2000,
        DEVICE_OUT_DGTL_DOCK_HEADSET = 0x4000,
        DEVICE_OUT_DIRECTOUTPUT = 0x8000,
        DEVICE_OUT_DEFAULT = 0x10000,
        DEVICE_OUT_FM_TX = 0x20000,
#else
...
#ifdef HAVE_FM_RADIO
                DEVICE_OUT_FM | DEVICE_OUT_FM_SPEAKER | DEVICE_OUT_DIRECTOUTPUT |
#endif
                DEVICE_OUT_DEFAULT),
